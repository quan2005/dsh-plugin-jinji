...
| 文档 | 讲什么 |
|---|---|
| [docs/architecture.md](docs/architecture.md) | 插件怎么分成「服务端部分」和「浏览器部分」、数据怎么流动、官方接口；记忆系统核心架构：**summary 分层加载 + 双轨记忆（流水 / 画像实体）**，配图 |
| [docs/api.md](docs/api.md) | 后台接口的完整约定：请求、响应字段、配置项、兼容边界 |
| [docs/design-decisions.md](docs/design-decisions.md) | 每个重要取舍的记录：为什么这么做、理由、有什么风险（ADR-0001 ~ 0008，含核心架构 ADR-0007 与双轨记忆 ADR-0008） |
